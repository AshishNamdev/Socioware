...
<html>
    <head>
        ...
        <title>Socioware/SecondUserProfile</title>
        <style>
.ul2{
    list-style: none;
    margin: 0px;
   ...
   border-collapse: collapse;
    ...
    <body id="bd">
        <%
            ...
            if(sessobj==null){
                %>
                <jsp:forward page="LoggedOut.jsp"></jsp:forward>
                <%
                     }              
                  else{
	...
	<tr>
            <th></th><td align="right"><input id="Create" type="submit" title="Create your event" value="create" ></td>
                ...
                <li class="l"><a class="a2" href="#"><%=usr.loginUser(email)%></a>
                <ul>
       ...
       <form action="PublishStatusServlet" method="post">
        ...
        <div id="dv5">
            ...
            <span id="span3"><a class="a1_1" id="a1" href="#"><%= usr.getName()%></a>
                        </span>
            <div id="dv8">
               <ul class="ul2">
                 <% 
                 ...
                 <%
                     ...
                     fl.setUserid(id);
                      ...
                      String frndIimage=null;
                        ...
                        {
                            frndIimage=fls.get(i).getUserimage();
                            if(frndIimage==null)
                                frndIimage="na.jpg";
                       %>
                <div class="frnd">
                     <a id="rs" href="SecondUserProfile.jsp?qid=<%=fls.get(i).getFriendid()%>">
                         <img width="40px" height="40px" alt="ulpoads/na.jpg" src="uploads/<%=frndIimage%>" />
