...
#issueTxt{
	...
	<tr>
            <th></th><td align="right"><input id="Create"type="Button" title="Create your event" value="create" ></td>
                ...
                <li class="l"><a class="a2" href="#"><%=nsr.getName() %></a>
                <ul>
                    <li><a class="a2" href="NgoInfo.jsp?qid=<%=id%>">Home</a></li>
                    <li><a class="a2" href="NgoProfile.jsp">Profile</a></li>
       ...
       <form action="PublishStatusServlet" method="post">
        ...
        <div id="dv5">
            <div id="dv7">
                <ul class="ul1">
                    <li class="li2"><a class="a5" id="DisplayInfo" href="NgoInfo.jsp?qid=<%=id%>">Ngo Info</a>
                    </li>
                    ...
                    <%
                       ...
                       NgoLogo nlg=nl.getLogo();
                        %>
            <div id="dv6">
                <a href="NgoInfo.jsp?qid=<%=id%>"> <img width="150px" height="120px" src="uploads/<%=nlg.getNgologo()%>" /></a>
                
                <span id="PhotoChange"> Change Ngo Logo</span>
               
            </div>
            <span id="span3"><a class="a1_1" id="a1" href="#">NGO Name:<%=nsr.getName()%></a>
                        </span>
            <div id="dv8">
               <ul class="ul2">
        ...
        <div id="ShowInfo">
            <br/><span class="info">NGO Name:<%=nsr.getName()%></span><br/><br/>
            <span class="info">Places:<%=nsr.getCity() %></span><br/><br/>
            <span class="info">Estd Date:<%=nsr.getEstd_yr() %></span>
        </div>                   
