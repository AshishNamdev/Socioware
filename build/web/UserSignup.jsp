            ...
            <div id="div1">
                ...
                <table id="tbl" cellspacing="0" cellpadding="3" margin="0" >
                      ...
                      <tr>
                         ...
                         <br/><td><input type="text" id="t1" value="First Name" class="txtarea" name="fname" onfocus="return invalid()"/>

                         <input type="text" id="t2" value="Middle Name" class="txtarea" name="mname" maxlength="10" onfocus="return invalid()"/>
                         <input type="text" id="t3" value="Last Name" class="txtarea" name="lname" maxlength="10" onfocus="return invalid()"/></td><br/><br/>
                      </tr>
                      <tr>
                         <th></th>
                      ...
                      <tr>
                         <th>User Name <span class="star">*</span></th>
                         <td><input type="text" id="t4" class="txtarea" value="User Id" name="email" onfocus="return invalid()"/>
                         @
                      ...
                      <tr>
                           <th>BirthDay <span class="star">*</span></th>
                           <td>
                               <select id="mm" name="mon" onchange="return changeOnSelect()">
                               ...
                               &nbsp;&nbsp;
                               <select id="dd" name="dd" onchange="return changeOnSelect()">
                      ...
                      <tr>
                         <th></th>
                         <td id="txt">fill your Date of Birth</td>
                     </tr>
                       <tr>
