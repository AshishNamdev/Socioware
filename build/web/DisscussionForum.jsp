...
#issueTxt{
	...
	<tr>
        ...
        <div id="main">
            <div id="TopicName">DiscussionTopic</div>
            <div id="Discussion">
                <table height="435px" border="1px" id="InnerDiscussion">
                    <tr class="DiscussionRow">
                        <th align="left" class="DiscussionUser">
                         <br/>  <span class="UserInfo"> User Name</span><br/><br/>
                              <span class="UserInfo"> place</span><br/><br/>
                            <span class="UserInfo">DiscussionDate</span>                 
                        </th>
                        <td  align="left" class="DiscussionComment">
                    ...
                    <tr class="DiscussionRow">
                        ...
                        <td align="left" class="DiscussionComment"></td>
                      </tr>
            ...
            <div id="SubmitComment">
                <form action="" method="post">
                    <div id="textarea"><textarea id="Comments" rows="3" cols="130"></textarea></div>
                    <div id="post"><input type="submit" value="&nbsp;&nbsp;Post&nbsp; " title="Click to Post"></div>
                    <div id="cancel"><input type="reset" value="cancel" title="Click to cancel"></div>
                </form>
            </div>
        </div>
