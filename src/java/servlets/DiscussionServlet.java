...
public class DiscussionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db.setTopic(request.getParameter("topic").trim());
            db.setTopicdesc(request.getParameter("topicdesc").trim());
            db.setDiscid("dis"+UniqueId.generateId());
            db.setTopicdate(DbContainor.getDate());
